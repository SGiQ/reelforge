...
const STEPS = [
    { n: 1, label: "Brand", color: "var(--color-accent)", desc: "Logo, watermark & QR" },
    { n: 2, label: "Scenes", color: "var(--color-accent)", desc: "Text, image & video" },
    { n: 3, label: "Theme", color: "var(--color-accent)", desc: "Colors & voice" },
    { n: 4, label: "Preview", color: "var(--color-accent)", desc: "Watch it animate" },
    { n: 5, label: "Export", color: "var(--color-accent)", desc: "Render your MP4" },
];
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="mb-12">
                    <p className="step-indicator mb-3">
                        ...
                        <span style={{ color: "var(--color-accent)" }}>How it works</span>
                    </p>
                ...
                <div className="space-y-5">
                    {/* Step 1 — Brand */}
                    <Section icon={<ImageIcon className="w-5 h-5" />} title="1. Set up your brand" accent="var(--color-accent)">
                    ...
                    {/* Step 2 — Scenes */}
                    <Section icon={<Clapperboard className="w-5 h-5" />} title="2. Build your scenes" accent="var(--color-accent)">
                        ...
                        <div className="grid sm:grid-cols-3 gap-3 my-2">
                            <div className="rounded-xl p-3" style={{ background: "rgba(198,241,53,0.08)", border: "1px solid rgba(198,241,53,0.2)" }}>
                                <div className="flex items-center gap-2 font-semibold mb-1" style={{ color: "var(--color-accent)" }}><Type className="w-4 h-4" /> Text scene</div>
                            ...
                            <div className="rounded-xl p-3" style={{ background: "rgba(198,241,53,0.08)", border: "1px solid rgba(198,241,53,0.25)" }}>
                                <div className="flex items-center gap-2 font-semibold mb-1" style={{ color: "var(--color-accent)" }}><Video className="w-4 h-4" /> Video scene</div>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li className="flex items-start gap-2"><Search className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Upload</strong> an MP4/MOV/WebM, or <strong style={{ color: "#cbd5e1" }}>search stock footage</strong> (powered by Pexels) and pick a clip.</span></li>
                            <li className="flex items-start gap-2"><Scissors className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Trim</strong> the clip with start/end seconds.</span></li>
                            <li className="flex items-start gap-2"><MessageSquareText className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span>Add a <strong style={{ color: "#cbd5e1" }}>caption</strong> — it overlays on the clip and is what the AI voiceover speaks.</span></li>
                            <li className="flex items-start gap-2"><ArrowUpDown className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Reorder</strong> scenes with the up/down arrows.</span></li>
                        </ul>
                        <p className="flex items-center gap-2 pt-1"><Sparkles className="w-4 h-4" style={{ color: "var(--color-accent)" }} /> In a hurry? Use <strong style={{ color: "#cbd5e1" }}>Generate Script with AI</strong> to draft your text scenes from a prompt.</p>
                    ...
                    {/* Motion & animation */}
                    <Section icon={<Wand2 className="w-5 h-5" />} title="Bring scenes to life — motion & animation" accent="var(--color-accent)">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li className="flex items-start gap-2"><Clock className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Hold</strong> — how many seconds the scene stays on screen before the next one. Leave it blank for auto (it matches the voiceover length, and never cuts a longer one off).</span></li>
                            <li className="flex items-start gap-2"><ZoomIn className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Background</strong> — a slow Ken-Burns move on the scene: <em>Zoom in</em>, <em>Zoom out</em>, or <em>Pan</em> left/right.</span></li>
                            <li className="flex items-start gap-2"><Type className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Text in</strong> — how the caption appears: <em>Fade</em>, <em>Fade up</em>, or <em>Slide</em> in from a side.</span></li>
                        </ul>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li className="flex items-start gap-2"><Shapes className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Icon</strong> — search a built-in icon set (hearts, stars, arrows, check marks…) and tint it any color.</span></li>
                            ...
                            <li className="flex items-start gap-2"><ImageIcon className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Upload</strong> — drop in your own PNG/SVG graphic or sticker.</span></li>
                        ...
                        <p className="flex items-center gap-2 pt-1"><Blend className="w-4 h-4" style={{ color: "var(--color-accent)" }} /> Scenes <strong style={{ color: "#cbd5e1" }}>crossfade</strong> into each other automatically for a smooth flow.</p>
                        <p className="rounded-lg px-3 py-2 mt-1 text-xs" style={{ background: "rgba(198,241,53,0.08)", border: "1px solid rgba(198,241,53,0.2)", color: "#cbd5e1" }}>
                    ...
                    {/* Step 3 — Theme & voice */}
                    <Section icon={<Palette className="w-5 h-5" />} title="3. Pick a theme & voice" accent="var(--color-accent)">
                        <p>Choose a color theme that sets the gradient, text and accent colors across the reel.</p>
                        <p className="flex items-center gap-2"><Mic className="w-4 h-4" style={{ color: "var(--color-accent)" }} /> Pick an <strong style={{ color: "#cbd5e1" }}>AI voice</strong> to narrate the reel. The voice speaks each text scene, each video caption, and your final outro line.</p>
                        <p className="flex items-center gap-2"><Music className="w-4 h-4" style={{ color: "var(--color-accent)" }} /> Add <strong style={{ color: "#cbd5e1" }}>background music</strong> — pick a royalty-free track from the <strong style={{ color: "#cbd5e1" }}>music library</strong> or upload your own, then set its volume. It’s mixed quietly under the voiceover.</p>
                    </Section>

                    {/* Step 4 — Preview */}
                    <Section icon={<Eye className="w-5 h-5" />} title="4. Preview" accent="var(--color-accent)">
                    ...
                    {/* Step 5 — Export */}
                    <Section icon={<Download className="w-5 h-5" />} title="5. Export your MP4" accent="var(--color-accent)">
                    ...
                    {/* Dashboard */}
                    <Section icon={<LayoutDashboard className="w-5 h-5" />} title="Your dashboard" accent="var(--color-accent)">
                        <ul className="list-disc pl-5 space-y-1">
                            <li className="flex items-start gap-2"><Play className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Click any reel</strong> to play it full-screen with sound.</span></li>
                            <li className="flex items-start gap-2"><Download className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Download</strong> the finished MP4.</span></li>
                            <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-accent)" }} /><span><strong style={{ color: "#cbd5e1" }}>Re-edit</strong> reloads a past reel’s brand, scenes, theme and audio so you can tweak and re-render.</span></li>
                        </ul>
                    </Section>

                    {/* Good to know */}
                    <Section icon={<Sparkles className="w-5 h-5" />} title="Good to know" accent="var(--color-accent)">
                        <ul className="list-disc pl-5 space-y-1">
