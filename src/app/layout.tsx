    ...
    return (
        <html lang="en" className="dark" suppressHydrationWarning>
            <head>
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Space+Grotesk:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&family=Montserrat:wght@700;900&family=Oswald:wght@700&family=Bebas+Neue&family=Cinzel:wght@700&family=Space+Mono:wght@700&family=Playfair+Display:wght@700;900&family=Outfit:wght@700;900&display=swap"
                    rel="stylesheet"
                />
            </head>
