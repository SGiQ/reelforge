...
export default function HomePage() {
    return (
        <div className="page-container">
            {/* Nav */}
            <header className="sticky top-0 z-50 w-full" style={{ borderBottom: "1px solid rgb(var(--rgb-surface-border) / 0.4)", background: "rgb(var(--rgb-surface) / 0.9)", backdropFilter: "blur(12px)" }}>
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/dashboard" className="text-sm font-medium" style={{ color: "var(--color-text-secondary)" }}>Dashboard</Link>
            ...
            <section className="relative overflow-hidden py-28 px-6">
                ...
                <div className="relative max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-2xl mx-auto" style={{ color: "var(--color-text-secondary)" }}>
                    ...
                    <p className="mt-6 text-sm" style={{ color: "var(--color-text-muted)" }}>No credit card required — free plan available</p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p style={{ color: "var(--color-text-secondary)" }}>Built for brand owners who don&apos;t have time to learn complex video tools.</p>
                    </div>
            ...
            <section className="py-20 px-6">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p style={{ color: "var(--color-text-secondary)" }}>Four steps from zero to shareable MP4.</p>
                    </div>
                ...
                <div className="max-w-2xl mx-auto text-center">
                    <div className="animated-border">
                        <div className="animated-border-inner p-12">
                            ...
                            <p className="mb-8" style={{ color: "var(--color-text-secondary)" }}>Join brand owners creating reels that convert.</p>
            ...
            {/* Footer */}
            <footer className="py-10 px-6 border-t" style={{ borderColor: "rgb(var(--rgb-surface-border) / 0.4)" }}>
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        <Zap className="w-4 h-4" style={{ color: "#a78bfa" }} />
                        <span className="font-bold">ReelSGiQ</span>
                    </div>
                    <p className="text-sm" style={{ color: "var(--color-text-muted)" }}>© 2026 ReelSGiQ. All rights reserved.</p>
